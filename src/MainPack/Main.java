...
public class Main extends javax.swing.JFrame {
    ...
    private void createAccountOkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createAccountOkButtonActionPerformed
        ...
        */
        ...
        if(!(gdfldbobj.getOfficerExistFromDB(caoid))&&!(gdfldbobj.getAdNameExistFromDB(caName))&&!(caName.equals(""))&&!(caPw.equals("")&&!(caeMl.equals(""))&&!(caadd.equals(""))&&!(cac1.equals(""))&&!(cac2.isEmpty())&&!(caoid.isEmpty())&&(specch==true && checkCount==2 && !(email.startsWith(" "))&& !isspace && !illCH)) &&!inValid)
        {
        ...
        {
         JOptionPane.showMessageDialog(this, "Sorry.. Problem Occured","No PerMission", JOptionPane.ERROR_MESSAGE);
        ...
        {
        JOptionPane.showMessageDialog(this, "Sorry.. You Must Have To Enter Super Password !","Wrong Way", JOptionPane.ERROR_MESSAGE);
        }
